...
deploy_to_env () {
    ...
    rsync -r -a -v -e ssh --delete $(pwd)/wp-content/plugins ec2-user@13.239.37.152:/ecs/cp3402-${env}-storage/wp-content/plugins
    rsync -r -a -v -e ssh --delete -o $(pwd)/wp-content/themes/arabusta ec2-user@13.239.37.152:/ecs/cp3402-${env}-storage/wp-content/themes/arabusta
}
